        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBookAvailable = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Rohan", "user123", 10, "user1" },
                    { 2, "Rohan", "user123", 10, "user1" },
                    { 3, "Rohan", "user123", 10, "user1" },
                    { 4, "Rohan", "user123", 10, "user1" }
                });
